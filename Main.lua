...
local funcs = {}; do
    function funcs:require(url, bypass, bypass2)
        ...
        local newUrl = (bypass and "https://raw.githubusercontent.com/jaszondaeo/" or "https://raw.githubusercontent.com/jaszondaeo/engoware/") .. url:gsub("engoware/", ""):gsub("engoware\\", "")
